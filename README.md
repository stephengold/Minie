...
repository location:
    ...
    dependencies {
        compile 'jme3utilities:Minie:0.9.1'
    }
...
libraries from GitHub:
 ...
 + https://github.com/stephengold/Minie/releases/tag/0.9.1
 + https://github.com/stephengold/jme3-utilities/releases/tag/heart-2.28.0
...
Open the project's properties in the IDE (JME 3.2 SDK or NetBeans 8.2):
 ...
 5. Add the `jme3-utilities-heart` class JAR:
    ...
    + Select the "jme3-utilities-heart-2.28.0.jar" file.
    + Click on the "Open" button.
 6. (optional) Add JARs for javadoc and sources:
    + Click on the "Edit" button.
    + Click on the "Browse..." button to the right of "Javadoc:"
    + Select the "jme3-utilities-heart-2.28.0-javadoc.jar" file.
    + Click on the "Open" button.
    + Click on the "Browse..." button to the right of "Sources:"
    + Select the "jme3-utilities-heart-2.28.0-sources.jar" file.
