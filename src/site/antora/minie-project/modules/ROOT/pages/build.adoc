...
.. using Windows PowerShell: `$env:JAVA_HOME = '` *path to your JDK* `'`
. Run the Gradle wrapper:
.. using Bash or Windows PowerShell:  `./gradlew build`
...
* using Bash or Windows PowerShell:  `./gradlew publishToMavenLocal`
 ...
 * using Bash or Windows PowerShell:  `./gradlew clean`
