...
dependencies {
    compile 'com.github.stephengold:Minie:3.0.0'
}
----
...
* https://github.com/stephengold/Minie/releases/tag/3.0.0
...
* Minie v3.0.0 depends on jme3-terrain-3.3.2-stable and
* Heart v6.0.0 depends on jme3-core-3.3.2-stable
