...
dependencies {
    implementation 'com.github.stephengold:Minie:7.8.1'
}
----
...
.. Select the "Minie-7.8.1.jar" file.
...
.. Select the "Minie-7.8.1-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Minie-7.8.1-sources.jar" file.
