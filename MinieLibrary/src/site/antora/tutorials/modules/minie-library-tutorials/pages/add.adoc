...
dependencies {
    compile 'com.github.stephengold:Minie:4.2.0'
}
----
...
* https://github.com/stephengold/Minie/releases/tag/4.2.0
...
* Minie v4.2.0 depends on jme3-terrain-3.4.0-stable and
