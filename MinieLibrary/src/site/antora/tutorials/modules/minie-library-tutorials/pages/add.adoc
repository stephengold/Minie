...
* https://github.com/stephengold/Minie/releases/tag/4.5.0
* https://github.com/stephengold/Heart/releases/tag/7.1.0
...
* Minie v4.5.0 depends on jme3-terrain-3.4.0-stable and
* Heart v7.1.0 depends on jme3-core-3.4.0-stable
