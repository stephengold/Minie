...
* https://github.com/stephengold/Minie/releases/tag/4.6.1
...
you'll need version 3.5.x JMonkeyEngine libraries:

* Minie v4.6.1 depends on jme3-terrain-3.5.0-stable and
* Heart v7.2.0 depends on jme3-core-3.5.0-stable
...
* Starting with version 4.6.1,
  Minie no longer supports version 3.4.x JMonkeyEngine libraries.
