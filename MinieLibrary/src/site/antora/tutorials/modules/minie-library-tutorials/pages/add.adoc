...
dependencies {
    implementation 'com.github.stephengold:Minie:5.1.0'
}
----
...
* https://github.com/stephengold/Minie/releases/tag/5.1.0
...
.. Select the "Minie-5.1.0.jar" file.
...
.. Select the "Minie-5.1.0-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Minie-5.1.0-sources.jar" file.
