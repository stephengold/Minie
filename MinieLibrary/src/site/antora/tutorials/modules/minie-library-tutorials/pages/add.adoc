...
dependencies {
    implementation 'com.github.stephengold:Minie:5.0.1'
}
----
...
Download the {Project}, Heart, and SimMath libraries from GitHub:

* https://github.com/stephengold/Minie/releases/tag/5.0.1
...
see https://stephengold.github.io/Minie/minie/depends.html[the Library version dependencies page in the Minie documentation].
