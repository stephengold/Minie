...
dependencies {
    compile 'com.github.stephengold:Minie:4.1.1'
}
----
...
* https://github.com/stephengold/Minie/releases/tag/4.1.1
* https://github.com/stephengold/Heart/releases/tag/6.4.4
...
.. Select the "Heart-6.4.3+for33" file.
...
* Minie v4.1.1 depends on jme3-terrain-3.4.0-stable and
* Heart v6.4.4 depends on jme3-core-3.4.0-stable
...
For Minie to work on Android platforms running Marshmellow (6.0) or higher,
