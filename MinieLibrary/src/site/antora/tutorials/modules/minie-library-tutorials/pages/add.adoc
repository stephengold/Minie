...
.. Select the "Minie-5.0.1.jar" file.
...
.. Select the "Minie-5.0.1-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Minie-5.0.1-sources.jar" file.
...
[source,java]
----
static BulletAppState bas = new BulletAppState();
----
====
