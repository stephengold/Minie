...
* https://github.com/stephengold/Minie/releases/tag/4.7.1
...
* Minie v4.7.1 depends on jme3-terrain-3.5.0-stable and
* Heart v7.4.1 depends on jme3-core-3.5.0-stable
