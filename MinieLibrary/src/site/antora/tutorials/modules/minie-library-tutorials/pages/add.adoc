...
dependencies {
    compile 'com.github.stephengold:Minie:4.1.0+for33'
}
----
...
* https://github.com/stephengold/Minie/releases/tag/4.1.0+for33
...
* Minie v4.1.0+for33 depends on jme3-terrain-3.3.2-stable and
* Heart v6.4.3+for33 depends on jme3-core-3.3.2-stable
