...
* https://github.com/stephengold/Heart/releases/tag/8.6.0
...
.. Select the "Minie-7.6.0.jar" file.
...
.. Select the "Minie-7.6.0-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Minie-7.6.0-sources.jar" file.
