...
dependencies {
    implementation 'com.github.stephengold:Minie:4.8.0'
}
----
...
* https://github.com/stephengold/Minie/releases/tag/4.8.0
...
* Minie v4.8.0 depends on jme3-core-3.5.1-stable and jme3-terrain-3.5.1-stable .
